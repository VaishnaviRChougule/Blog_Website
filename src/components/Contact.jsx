...
<div className="py-40 bg-black text-center text-white px-4">
        <h2 className="tex-5xl lg:text-7xl leading-snug font-bold mb-5"> Contact Us Page. </h2>
            </div>

            <div class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img src={contact} alt="" className="object-cover object-center rounded" />
          </div>
...
<div className="w-96 h-[60vh] text-left  lg:max-w-lg lg:w-full md:w-1/2 my-10 py-4 bg-[#efe1fa] rounded-lg">
  

<form class="max-w-md mx-auto px-5 py-10">
  ...
  <div class="grid  md:gap-5">
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="text" name="floating_message" id="floating_company" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
